...
/**
 * Alcance Academic: empresa de sesión; superadmin puede elegir empresa en pantallas Academic.
 * Calco de SgdScopeService.
 */
class AcadScopeService
{
    ...
    public function requireEmpresaId(array $query = []): int
    {
        ...
        if ($id === null || $id <= 0) {
            throw new RuntimeException('Seleccione una empresa en el contexto o en el filtro Academic.');
        }
